...
class LaneDataSet(Dataset):
    def __init__(self, dataset, n_labels=3, transform=None,shuffle=True):
        self._gt_img_list = []
        ...
        # The stored dataset should be the path of the corresponding data file
        ...
        # Check whether the three quantities correspond
